(function () {
    ...
    class Tiro
    {
        constructor(nave)
        {
            ...
            this.element.src = "img/laserRed.png"; // Recebe uma imagem da pasta
    ...
    class AsteroideGrande
    {
        constructor()
        {
            ...
            this.element.src = "img/meteorBig.png"; // Recebe uma imagem da pasta
    ...
    class AsteroidePequeno
    {
        constructor()
        {
            ...
            this.element.src = "img/meteorSmall.png"; // Recebe uma imagem da pasta
            this.element.style.top = "0px"; // Isso indica o movimento vertial do inimigo
            this.element.style.left = `${
                Math.floor(Math.random()*(TAMX-100))
            }px`
    ...
    class EnemyShip
    {
        constructor()
        {
            ...
            this.element.src = "img/enemyShip.png"; // Recebe uma imagem da pasta
            this.element.style.top = "0px"; // Isso indica o movimento vertial do inimigo
            this.element.style.left = `${
                Math.floor(Math.random()*(TAMX-100))
            }px`
    ...
    class DiscoVoador
    {
        constructor()
        {
            ...
            this.element.src = "img/enemyUFO.png"; // Recebe uma imagem da pasta
            this.element.style.top = "0px"; // Isso indica o movimento vertial do inimigo
            this.element.style.left = `${
                Math.floor(Math.random()*(TAMX-100))
            }px`
